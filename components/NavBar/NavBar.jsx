        ...
        <>
            <div className="bg-customGray">
                ...
                <div className="h-14 w-11/12 m-auto flex justify-between">
                    ...
                    <nav className="h-full flex items-center nav uppercase space-x-4">
                        <Link href="/"><a className="text-white hover:text-red-400 transition duration-500">Sobre nosotros</a></Link>
                        <Link href="/"><a className="text-white hover:text-red-400 transition duration-500">Galeria</a></Link>
                        <Link href="/"><a className="text-white hover:text-red-400 transition duration-500">Videos</a></Link>
                        <Link href="/"><a className="text-white hover:text-red-400 transition duration-500">Contacto</a></Link>
                    </nav>
                </div>
            </div>
        </>
